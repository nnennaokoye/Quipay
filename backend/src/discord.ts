...
const DISCORD_PUBLIC_KEY = process.env.DISCORD_PUBLIC_KEY || "dummy_key_for_dev_mode";
 ...
 */
function verifyDiscordSignature(req: Request, res: Response, buf: Buffer, encoding: string) {
